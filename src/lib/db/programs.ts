 ...
 *  3 → 6 (день-54): курс на многодневные программы — одна «программа» в текущей модели =
 *  один день, реальный недельный сплит уже занимает 3-4 слота. */
export const MAX_USER_PROGRAMS = 6;
