-- Власна вага атлета в витрине борда (фидбек: в грип-спорте результат читается через вес тела).
-- Участие в борде = согласие показать результат; вес тела подтягиваем из профиля участника
-- (только у тех, кто подал заявку, и только через это security definer окно).
